...
static GPIO_PinState ReadButtonDebounced(void)
{
    GPIO_PinState firstRead = HAL_GPIO_ReadPin(PUSH_BUTTON_GPIO_Port, PUSH_BUTTON_Pin);
    HAL_Delay(15);
    GPIO_PinState secondRead = HAL_GPIO_ReadPin(PUSH_BUTTON_GPIO_Port, PUSH_BUTTON_Pin);
